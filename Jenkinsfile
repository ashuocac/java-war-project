pipeline {
  ...
  stages {
    ...
    stage('deployment on tomcat') {
      ...
      steps {
        sh """
             wget --http-user=${jfrog_user}  --http-password=${jfrog_pass} https://devops400.jfrog.io/artifactory/devops/com/mycompany/app/my-app-ashu/2.0/my-app-ashu-2.0.war
             mv my-app-ashu-2.0.war my-app-ashu.war
             cp my-app-ashu.war /home/rocky/tomcat/tomcat9/webapps/
          """
      }
    }
  }
